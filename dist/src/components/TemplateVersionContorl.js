...
export function createversion() {
  ...
  async function detectChanges(divElement) {
    let jsonResult;
    if (localStorage.getItem("htmljson") === "undefined") {
      jsonResult = {};
    } else {
      jsonResult = JSON.parse(localStorage.getItem("htmljson"));
    }
    console.log(divElement, "ffff");
...
export function applyChangesFromV1toV2withouthighlight(
  ...
  document.querySelectorAll(".redhighlight").forEach(function (element) {
