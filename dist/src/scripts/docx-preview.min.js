!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("jszip"))
    : "function" == typeof define && define.amd
    ? define(["exports", "jszip"], t)
    : t(
        ((e = "undefined" != typeof globalThis ? globalThis : e || self).docx =
          {}),
        e.JSZip
      );
})(this, function (e, t) {
  ...
  function n(e, t = s.Dxa) {
    return null == e || /.+(p[xt]|[%])$/.test(e)
      ? e
      : `${(parseInt(e) * t.mul).toFixed(2)}${t.unit}`;
  }
  function l(e, t, r) {
  ...
  class c {
    ...
    save() {
      ...
      this._package.update(
        this.path,
        ((e = this._xmlDocument), new XMLSerializer().serializeToString(e))
      );
    }
    parseXml(e) {}
  }
  ...
  class d extends c {
    parseXml(e) {
      this.fonts = u(e, this._package.xmlParser);
    }
  }
  function m(e) {
  ...
  class v {
    ...
    async loadRelationships(e = null) {
      ...
      return r
        ? ((a = this.parseXmlDocument(r).firstElementChild),
          (s = this.xmlParser).elements(a).map((e) => ({
            id: s.attr(e, "Id"),
            type: s.attr(e, "Type"),
            target: s.attr(e, "Target"),
            targetMode: s.attr(e, "TargetMode"),
          })))
        : null;
      var a, s;
    }
    parseXmlDocument(e) {
      return (function (e, t = !1) {
        var r;
        t && (e = e.replace(/<[?].*[?]>/, "")),
          (e = 65279 === (r = e).charCodeAt(0) ? r.substring(1) : r);
  ...
  function P(e, t) {
    return {
      ...
      size: t.lengthAttr(e, "sz", s.Border),
      offset: t.lengthAttr(e, "space", s.Point),
  ...
  function E(e, t) {
    let r = {};
    for (let a of t.elements(e)) D(a, r, t);
    return r;
  }
  function D(e, t, r) {
    return !!l(e, t, r);
  ...
  class W extends c {
    ...
    parseXml(e) {
      (this.rootElement = this.createRootElement()),
        (this.rootElement.children = this._documentParser.parseBodyElements(e));
    }
  }
  class X extends W {
    createRootElement() {
  ...
  class ue {
    ...
    async loadRelationshipPart(e, t) {
      ...
      switch (t) {
        case r.OfficeDocument:
          ...
          break;
        case r.FontTable:
          this.fontTablePart = a = new d(this._package, e);
          break;
        case r.Numbering:
      ...
      if (
        ...
        const [e] = m(a.path);
        await Promise.all(
          a.rels.map((t) => this.loadRelationshipPart(f(t.target, e), t.type))
        );
      }
      return a;
    }
    ...
    async loadFont(e, t) {
      ...
      return r ? this.blobToURL(new Blob([pe(r, t)])) : r;
    }
    blobToURL(e) {
      return e
    ...
    for (const a of i.elements(e))
      switch (a.localName) {
        ...
        case "imagedata":
          (r.tagName = "image"),
            Object.assign(r.attrs, { width: "100%", height: "100%" }),
            (r.imageHref = { id: i.attr(a, "id"), title: i.attr(a, "title") });
          break;
        case "txbxContent":
  ...
  function be(e) {
    return {
      stroke: i.attr(e, "color"),
      "stroke-width": i.lengthAttr(e, "weight", s.Emu) ?? "1px",
    };
  }
  function ge(e) {
    return e.split(",");
  ...
  class xe {
      ...
      return (
        Ne.foreach(e, (e) => {
          switch (e.localName) {
            ...
            default:
              this.options.debug &&
                console.warn(`DOCX: Unknown style element: ${e.localName}`);
          }
        }),
        t
      );
    ...
    parseParagraph(e) {
      ...
      for (let s of i.elements(e))
        switch (s.localName) {
          ...
          case "sdt":
            a.children.push(
              ...this.parseSdt(s, (e) => this.parseParagraph(e).children)
            );
            break;
          case "ins":
            a.children.push(
              this.parseInserted(s, (e) => this.parseParagraph(e))
            );
            break;
          case "del":
            a.children.push(
              this.parseDeleted(s, (e) => this.parseParagraph(e))
            );
        }
      return a;
    }
      ...
      this.parseDefaultProperties(e, (t.cssStyle = {}), null, (e) => {
        ...
        switch (e.localName) {
          case "pStyle":
            ...
            break;
          case "cnfStyle":
            t.className = Me.classNameOfCnfStyle(e);
            break;
          case "framePr":
            this.parseFrame(e, t);
            break;
        ...
        Ne.foreach(e, (e) => {
          switch ((e = this.checkAlternateContent(e)).localName) {
            ...
            case "fldSimple":
              r.children.push({
                type: C.SimpleField,
                instruction: i.attr(e, "instr"),
                lock: i.boolAttr(e, "lock", !1),
                dirty: i.boolAttr(e, "dirty", !1),
              });
              break;
            case "instrText":
              (r.fieldRun = !0),
                r.children.push({ type: C.Instruction, text: e.textContent });
              break;
            case "fldChar":
              (r.fieldRun = !0),
                r.children.push({
                  type: C.ComplexField,
                  charType: i.attr(e, "fldCharType"),
                  lock: i.boolAttr(e, "lock", !1),
                  dirty: i.boolAttr(e, "dirty", !1),
                });
              break;
            ...
            case "br":
              r.children.push({
                type: C.Break,
                break: i.attr(e, "type") || "textWrapping",
              });
              break;
            ...
            case "footnoteReference":
              r.children.push({
                type: C.FootnoteReference,
                id: i.attr(e, "id"),
              });
              break;
            case "endnoteReference":
              r.children.push({
                type: C.EndnoteReference,
                id: i.attr(e, "id"),
              });
              break;
            case "drawing":
    ...
    parseMathElement(e) {
      const t = `${e.localName}Pr`,
        r = { type: we[e.localName], children: [] };
      for (const s of i.elements(e)) {
        if (we[s.localName]) r.children.push(this.parseMathElement(s));
      ...
      this.parseDefaultProperties(e, (t.cssStyle = {}), null, (e) => {
        switch (e.localName) {
          case "rStyle":
            ...
            break;
          case "vertAlign":
            t.verticalAlign = Me.valueOfVertAlign(e, !0);
            break;
          default:
            return !1;
        }
    ...
    checkAlternateContent(e) {
      ...
      if (t) {
        ...
        if (Pe.includes(a)) return t.firstElementChild;
      }
    ...
    parseDrawingWrapper(e) {
      ...
      let a = null,
        ...
        l = { relative: "page", align: "left", offset: "0" },
        o = { relative: "page", align: "top", offset: "0" };
      for (var c of i.elements(e))
        switch (c.localName) {
          case "simplePos":
            n &&
              ((l.offset = i.lengthAttr(c, "x", s.Emu)),
              (o.offset = i.lengthAttr(c, "y", s.Emu)));
            break;
          case "extent":
            (t.cssStyle.width = i.lengthAttr(c, "cx", s.Emu)),
              (t.cssStyle.height = i.lengthAttr(c, "cy", s.Emu));
            break;
          case "positionH":
          case "positionV":
            if (!n) {
              ...
              var h = i.element(c, "align"),
                u = i.element(c, "posOffset");
              (e.relative = i.attr(c, "relativeFrom") ?? e.relative),
                h && (e.align = h.textContent),
                u && (e.offset = Ne.sizeValue(u, s.Emu));
            }
            break;
      ...
      return (
        "wrapTopAndBottom" == a
          ...
          ? ((t.cssStyle.display = "block"),
            ...
            l.offset && (t.cssStyle.left = l.offset),
            o.offset && (t.cssStyle.top = o.offset))
          : !r ||
            ("left" != l.align && "right" != l.align) ||
            (t.cssStyle.float = l.align),
        t
      );
    }
    parseGraphic(e) {
    ...
    parsePicture(e) {
      ...
      for (var o of ((t.cssStyle.position = "relative"), i.elements(l)))
        switch (o.localName) {
          case "ext":
            (t.cssStyle.width = i.lengthAttr(o, "cx", s.Emu)),
              (t.cssStyle.height = i.lengthAttr(o, "cy", s.Emu));
            break;
          case "off":
            (t.cssStyle.left = i.lengthAttr(o, "x", s.Emu)),
              (t.cssStyle.top = i.lengthAttr(o, "y", s.Emu));
        }
      return t;
    }
    parseTable(e) {
    ...
    parseTableColumns(e) {
      ...
      return (
        Ne.foreach(e, (e) => {
          if ("gridCol" === e.localName)
            t.push({ width: i.lengthAttr(e, "w") });
        }),
        t
      );
    }
        ...
        this.parseDefaultProperties(e, t.cssStyle, t.cellStyle, (e) => {
          switch (e.localName) {
            case "tblStyle":
              ...
              break;
            case "tblLook":
              t.className = Me.classNameOftblLook(e);
              break;
            case "tblpPr":
    ...
    parseTablePosition(e, t) {
      ...
      (t.cssStyle.float = "left"),
        (t.cssStyle["margin-bottom"] = Me.addSize(
          t.cssStyle["margin-bottom"],
          a
        )),
        (t.cssStyle["margin-left"] = Me.addSize(t.cssStyle["margin-left"], n)),
        (t.cssStyle["margin-right"] = Me.addSize(
          t.cssStyle["margin-right"],
          s
        )),
        (t.cssStyle["margin-top"] = Me.addSize(t.cssStyle["margin-top"], r));
    }
    parseTableRow(e) {
      ...
      return (
        ...
        Ne.foreach(e, (n) => {
          if (!a?.(n))
            switch (n.localName) {
              case "jc":
                t["text-align"] = Me.valueOfJc(n);
                break;
              case "textAlignment":
                t["vertical-align"] = Me.valueOfTextAlignment(n);
                break;
              case "color":
                t.color = Ne.colorAttr(n, "val", null, ke);
                break;
              case "sz":
                t["font-size"] = t["min-height"] = i.lengthAttr(
                  n,
                  "val",
                  s.FontSize
                );
                break;
              case "shd":
                t["background-color"] = Ne.colorAttr(n, "fill", null, ye);
                break;
              case "highlight":
                t["background-color"] = Ne.colorAttr(n, "val", null, Se);
                break;
              case "vertAlign":
                break;
              case "position":
              ...
              case "tblW":
                t.width = Me.valueOfSize(n, "w");
                break;
              case "trHeight":
                this.parseTrHeight(n, t);
                break;
              case "strike":
                t["text-decoration"] = i.boolAttr(n, "val", !0)
                  ? "line-through"
                  : "none";
                break;
              case "b":
                ...
                break;
              case "i":
                t["font-style"] = i.boolAttr(n, "val", !0)
                  ? "italic"
                  : "normal";
                break;
              case "caps":
                t["text-transform"] = i.boolAttr(n, "val", !0)
                  ? "uppercase"
                  : "none";
                break;
              case "smallCaps":
                t["font-variant"] = i.boolAttr(n, "val", !0)
                  ? "small-caps"
                  : "none";
                break;
              case "u":
              ...
              case "tblBorders":
                ...
                break;
              case "tblCellSpacing":
                (t["border-spacing"] = Me.valueOfMargin(n)),
              ...
              case "tcMar":
                ...
                break;
              case "tblLayout":
                t["table-layout"] = Me.valueOfTblLayout(n);
                break;
              case "vAlign":
                t["vertical-align"] = Me.valueOfTextAlignment(n);
                break;
    ...
    parseUnderline(e, t) {
      ...
      if (null != r) {
        ...
        var a = Ne.colorAttr(e, "color");
        a && (t["text-decoration-color"] = a);
      }
    }
    parseFont(e, t) {
      var r = [i.attr(e, "ascii"), Me.themeValue(e, "asciiTheme")]
        .filter((e) => e)
        .join(", ");
    ...
    parseSpacing(e, t) {
      var r = i.lengthAttr(e, "before"),
        ...
        n = i.attr(e, "lineRule");
      if (
        (r && (t["margin-top"] = r), a && (t["margin-bottom"] = a), null !== s)
      )
        switch (n) {
          case "auto":
    ...
    parseMarginProperties(e, t) {
      Ne.foreach(e, (e) => {
        switch (e.localName) {
          case "left":
            t["padding-left"] = Me.valueOfMargin(e);
            break;
          case "right":
            t["padding-right"] = Me.valueOfMargin(e);
            break;
          case "top":
            t["padding-top"] = Me.valueOfMargin(e);
            break;
          case "bottom":
            t["padding-bottom"] = Me.valueOfMargin(e);
        }
      });
    }
    parseTrHeight(e, t) {
    ...
    parseBorderProperties(e, t) {
      Ne.foreach(e, (e) => {
        switch (e.localName) {
          case "start":
          case "left":
            t["border-left"] = Me.valueOfBorder(e);
            break;
          case "end":
          case "right":
            t["border-right"] = Me.valueOfBorder(e);
            break;
          case "top":
            t["border-top"] = Me.valueOfBorder(e);
            break;
          case "bottom":
            t["border-bottom"] = Me.valueOfBorder(e);
        }
      });
    }
  }
  ...
  class Ne {
    ...
    static colorAttr(e, t, r = null, a = "black") {
      var s = i.attr(e, t);
      if (s) return "auto" == s ? a : Ce.includes(s) ? s : `#${s}`;
  ...
  class Me {
    ...
    static valueOfBorder(e) {
      ...
      var t = Ne.colorAttr(e, "color");
      return `${i.lengthAttr(e, "sz", s.Border)} solid ${"auto" == t ? ve : t}`;
    }
  ...
  const Ae = { pos: 0, leader: "none", style: "left" };
  function Te(e, t, r, a = 0.75) {
    const s = e.closest("p"),
      ...
      u = Ee(r);
    let p = c.pos + u;
    if (p < h) for (; p < h && i.length < 50; p += u) i.push({ ...Ae, pos: p });
    const d = parseFloat(o.marginLeft),
      m = l.left + d,
      f = (n.left - m) * a,
      b = i.find((e) => "clear" != e.style && e.pos > f);
    if (null == b) return;
    let g = 1;
    if ("right" == b.style || "center" == b.style) {
      const t = Array.from(s.querySelectorAll(`.${e.className}`)),
        r = t.indexOf(e) + 1,
        n = document.createRange();
      n.setStart(e, 1), r < t.length ? n.setEndBefore(t[r]) : n.setEndAfter(s);
      const o = "center" == b.style ? 0.5 : 1,
        i = n.getBoundingClientRect(),
        c = i.left + o * i.width - (l.left - d);
      g = b.pos - c * a;
    } else g = b.pos - f;
    switch (
      ((e.innerHTML = "&nbsp;"),
      (e.style.textDecoration = "inherit"),
      (e.style.wordSpacing = `${g.toFixed(0)}pt`),
      b.leader)
    ) {
      case "dot":
      case "middleDot":
  ...
  class Be {
    constructor(e) {
      (this.htmlDocument = e),
        ...
        (this.tabsTimeout = 0),
        (this.tasks = []),
        (this.createElement = Fe);
    }
    render(e, t, r = null, a) {
      (this.document = e),
        (this.options = a),
        (this.className = a.className),
        (this.rootSelector = a.inWrapper
      ...
      this.options.inWrapper ? t.appendChild(this.renderWrapper(s)) : Oe(t, s),
    ...
    renderTheme(e, t) {
      ...
      if (s)
        for (let [e, t] of Object.entries(s.colors))
          r[`--docx-${e}-color`] = `#${t}`;
            ...
            this.document.loadFont(e.id, e.key).then((a) => {
              ...
              ("bold" != e.type && "boldItalic" != e.type) ||
                ...
                ("italic" != e.type && "boldItalic" != e.type) ||
                  (s["font-style"] = "italic"),
                _e(t, `docxjs ${r.name} font`);
              const n = this.styleToString("@font-face", s);
              t.appendChild(He(n)), this.refreshTabStops();
            })
          );
    }
    processStyleName(e) {
    ...
    processStyles(e) {
      ...
      for (const a of e.filter((e) => e.basedOn)) {
        var r = t[a.basedOn];
        if (r) {
          (a.paragraphProps = y(a.paragraphProps, r.paragraphProps)),
            (a.runProps = y(a.runProps, r.runProps));
          for (const e of r.styles) {
            const t = a.styles.find((t) => t.target == e.target);
            t
              ? this.copyStyleProperties(e.values, t.values)
              : a.styles.push({ ...e, values: { ...e.values } });
          }
        } else
          this.options.debug &&
    ...
    processElement(e) {
      if (e.children)
        for (var t of e.children)
          (t.parent = e),
            t.type == C.Table ? this.processTable(t) : this.processElement(t);
    }
    processTable(e) {
      for (var t of e.children)
    ...
    createSection(e, t) {
      ...
      return (
        t &&
          ...
          t.pageSize &&
            (this.options.ignoreWidth || (r.style.width = t.pageSize.width),
          ...
          t.columns &&
            ...
            t.columns.separator && (r.style.columnRule = "1px solid black"))),
        r
      );
    }
    renderSections(e) {
      ...
      for (let n = 0, l = r.length; n < l; n++) {
        ...
        this.renderStyleValues(e.cssStyle, c),
          this.options.renderHeaders &&
            this.renderHeaderFooter(i.headerRefs, i, t.length, a != i, c);
        ...
        this.renderElements(o.elements, s),
          ...
          this.options.renderFooters &&
            this.renderHeaderFooter(i.footerRefs, i, t.length, a != i, c),
          t.push(c),
          (a = i);
      }
      return t;
    ...
    renderHeaderFooter(e, t, r, a, s) {
      if (e) {
        var n =
            (t.titlePage && a ? e.find((e) => "first" == e.type) : null) ??
            (r % 2 == 1 ? e.find((e) => "even" == e.type) : null) ??
            e.find((e) => "default" == e.type),
          l =
            n &&
            this.document.findPartByRelId(n.id, this.document.documentPart);
        if (l) {
          (this.currentPart = l),
    ...
    splitBySection(e) {
      var t = { sectProps: null, elements: [] },
        r = [t];
      for (let i of e) {
        if (i.type == C.Paragraph) {
          const e = this.findStyle(i.styleName);
          e?.paragraphProps?.pageBreakBefore &&
            ((t.sectProps = a),
            (t = { sectProps: null, elements: [] }),
            r.push(t));
        }
        if ((t.elements.push(i), i.type == C.Paragraph)) {
          const e = i;
          ...
          if (
            (this.options.breakPages &&
              e.children &&
              (s = e.children.findIndex(
                (e) =>
                  -1 !=
                  (n =
                    e.children?.findIndex(this.isPageBreakElement.bind(this)) ??
                    -1)
              )),
            (a || -1 != s) &&
              ((t.sectProps = a),
            ...
            let r = e.children[s],
              a = n < r.children.length - 1;
            if (s < e.children.length - 1 || a) {
              var l = i.children,
                o = { ...i, children: l.slice(s) };
              if (((i.children = l.slice(0, s)), t.elements.push(o), a)) {
                let e = r.children,
                  t = { ...r, children: e.slice(0, n) };
                i.children.push(t), (r.children = e.slice(n));
              }
            }
          }
        }
      ...
      for (let e = r.length - 1; e >= 0; e--)
        null == r[e].sectProps ? (r[e].sectProps = i) : (i = r[e].sectProps);
      return r;
    }
    renderWrapper(e) {
    ...
    renderNumbering(e, t) {
      ...
      return (
        a.length > 0 &&
          (r += this.styleToString(this.rootSelector, {
      ...
      for (const o of e) {
        ...
        if (o.linked) {
          ...
          n
            ? (s = s.concat(n.styles))
            : this.options.debug &&
              console.warn(`Can't find linked style ${o.linked}`);
        }
        for (const e of s) {
          var l = `${o.target ?? ""}.${o.cssName}`;
          o.target != e.target && (l += ` ${e.target}`),
            a[o.target] == o && (l = `.${this.className} ${o.target}, ` + l),
            (t += this.styleToString(l, e.values));
        }
      }
      return He(t);
    }
    ...
    renderElement(e) {
      switch (e.type) {
        ...
        case C.MmlMath:
          return this.renderContainerNS(e, Re, "math", { xmlns: Re });
        case C.MmlMathParagraph:
          return this.renderContainer(e, "span");
        case C.MmlFraction:
          return this.renderContainerNS(e, Re, "mfrac");
        case C.MmlBase:
          return this.renderContainerNS(
            e,
            Re,
            e.parent.type == C.MmlMatrixRow ? "mtd" : "mrow"
          );
        case C.MmlNumerator:
        ...
        case C.MmlLimit:
        case C.MmlBox:
          return this.renderContainerNS(e, Re, "mrow");
        case C.MmlGroupChar:
          return this.renderMmlGroupChar(e);
        case C.MmlLimitLower:
          return this.renderContainerNS(e, Re, "munder");
        case C.MmlMatrix:
          return this.renderContainerNS(e, Re, "mtable");
        case C.MmlMatrixRow:
          return this.renderContainerNS(e, Re, "mtr");
        case C.MmlRadical:
          return this.renderMmlRadical(e);
        case C.MmlSuperscript:
          return this.renderContainerNS(e, Re, "msup");
        case C.MmlSubscript:
          return this.renderContainerNS(e, Re, "msub");
        case C.MmlDegree:
        case C.MmlSuperArgument:
        case C.MmlSubArgument:
          return this.renderContainerNS(e, Re, "mn");
        case C.MmlFunctionName:
          return this.renderContainerNS(e, Re, "ms");
        case C.MmlDelimiter:
    ...
    renderContainerNS(e, t, r, a) {
      return Le(t, r, a, this.renderChildren(e));
    }
    renderParagraph(e) {
    ...
    renderDeletedText(e) {
      return this.options.renderEndnotes
        ? this.htmlDocument.createTextNode(e.text)
        : null;
    }
    renderBreak(e) {
    ...
    renderVmlChildElement(e) {
      ...
      for (let r of e.children)
        r.type == C.VmlElement
          ? t.appendChild(this.renderVmlChildElement(r))
          : t.appendChild(...k(this.renderElement(r)));
      return t;
    }
    renderMmlRadical(e) {
      const t = e.children.find((e) => e.type == C.MmlBase);
      if (e.props?.hideDegree)
        return Le(Re, "msqrt", null, this.renderElements([t]));
      const r = e.children.find((e) => e.type == C.MmlDegree);
      return Le(Re, "mroot", null, this.renderElements([t, r]));
    }
    renderMmlDelimiter(e) {
      const t = [];
      return (
        t.push(Le(Re, "mo", null, [e.props.beginChar ?? "("])),
        t.push(...this.renderElements(e.children)),
        t.push(Le(Re, "mo", null, [e.props.endChar ?? ")"])),
        Le(Re, "mrow", null, t)
      );
    }
    renderMmlNary(e) {
      const t = [],
        r = b(e.children, (e) => e.type),
        a = r[C.MmlSuperArgument],
        s = r[C.MmlSubArgument],
        n = a ? Le(Re, "mo", null, k(this.renderElement(a))) : null,
        l = s ? Le(Re, "mo", null, k(this.renderElement(s))) : null,
        o = Le(Re, "mo", null, [e.props?.char ?? "∫"]);
      return (
        n || l
          ? t.push(Le(Re, "munderover", null, [o, l, n]))
          : n
          ? t.push(Le(Re, "mover", null, [o, n]))
          : l
          ? t.push(Le(Re, "munder", null, [o, l]))
          : t.push(o),
        t.push(...this.renderElements(r[C.MmlBase].children)),
        Le(Re, "mrow", null, t)
      );
    }
    renderMmlPreSubSuper(e) {
      const t = [],
        ...
        o = Le(Re, "mo", null);
      return (
        t.push(Le(Re, "msubsup", null, [o, l, n])),
        t.push(...this.renderElements(r[C.MmlBase].children)),
        Le(Re, "mrow", null, t)
      );
    }
    renderMmlGroupChar(e) {
      const t = "bot" === e.props.verticalJustification ? "mover" : "munder",
        r = this.renderContainerNS(e, Re, t);
      return (
        e.props.char && r.appendChild(Le(Re, "mo", null, [e.props.char])), r
      );
    }
    renderMmlBar(e) {
      const t = this.renderContainerNS(e, Re, "mrow");
    ...
    renderMllList(e) {
      const t = Le(Re, "mtable");
      this.renderClass(e, t),
        this.renderStyleValues(e.cssStyle, t),
        this.renderChildren(e);
      for (let r of this.renderChildren(e))
        t.appendChild(Le(Re, "mtr", null, [Le(Re, "mtd", null, [r])]));
      return t;
    }
    renderStyleValues(e, t) {
      for (let r in e)
        r.startsWith("$")
          ? t.setAttribute(r.slice(1), e[r])
          : (t.style[r] = e[r]);
    }
    renderClass(e, t) {
      ...
      this.options.experimental &&
        ...
        (this.tabsTimeout = setTimeout(() => {
          ...
          for (let t of this.currentTabs)
            Te(t.span, t.stops, this.defaultTabSize, e);
        }, 500)));
    }
  }
  function Fe(e, t, r) {
    return Le(void 0, e, t, r);
  }
  function $e(e, t, r) {
    return Le(De, e, t, r);
  }
  function Le(e, t, r, a) {
    ...
    return Object.assign(s, r), a && Oe(s, a), s;
  }
  function Ie(e) {
    e.innerHTML = "";
  }
  ...
  function ze(e, t) {
    const r = { ...Ve, ...t };
    return ue.load(e, new xe(r), r);
  }
  async function je(e, t, r, a) {
    const s = { ...Ve, ...a },
      n = new Be(window.document);
    return n.render(e, t, r, s), Promise.allSettled(n.tasks.filter((e) => e));
  }
  (e.defaultOptions = Ve),
    (e.praseAsync = ze),
    (e.renderAsync = async function (e, t, r, a) {
      const s = await ze(e, a);
