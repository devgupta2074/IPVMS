!(function (e, t) {
  ...
  class he extends c {
    ...
    parseXml(e) {
      (this.comments = this._documentParser.parseComments(e)),
        (this.commentMap = g(this.comments, (e) => e.id));
    }
  }
  class me extends c {
    constructor(e, t) {
  ...
  class Ee {
    ...
    parseComments(e) {
      ...
      for (let r of i.elements(e, "comment")) {
        const e = new ve();
        (e.id = i.attr(r, "id")),
          (e.author = i.attr(r, "author")),
          (e.initials = i.attr(r, "initials")),
          (e.date = i.attr(r, "date")),
          (e.children = this.parseBodyElements(r)),
          t.push(e);
      }
      return t;
    }
          ...
          case "positionV":
            if (!n) {
              ...
              (e.relative = i.attr(c, "relativeFrom") ?? e.relative),
                ...
                m && (e.offset = De.sizeValue(m, s.Emu));
            }
            break;
          ...
          if (!a?.(n))
            switch (n.localName) {
              ...
              case "tblBorders":
                ...
                break;
              case "tblCellSpacing":
                (t["border-spacing"] = Be.valueOfMargin(n)),
    ...
    parseFont(e, t) {
      var r = [i.attr(e, "ascii"), Be.themeValue(e, "asciiTheme")]
        .filter((e) => e)
        .join(", ");
  ...
  function $e(e, t, r, a = 0.75) {
    ...
    switch (
      ...
      (e.style.wordSpacing = `${b.toFixed(0)}pt`),
      g.leader)
    ) {
      case "dot":
      case "middleDot":
  ...
  class He {
    ...
    render(e, t, r = null, a) {
      ...
      this.options.inWrapper ? t.appendChild(this.renderWrapper(s)) : We(t, s),
    ...
    renderSections(e) {
      ...
      for (let r = 0, l = a.length; r < l; r++) {
        ...
        this.renderStyleValues(e.cssStyle, i),
          this.options.renderHeaders &&
            this.renderHeaderFooter(o.headerRefs, o, t.length, s != o, i);
        for (const e of a[r]) {
          var n = this.createSectionContent(e.sectProps);
          this.renderElements(e.elements, n),
            i.appendChild(n),
            (o = e.sectProps);
        }
        this.options.renderFootnotes &&
          this.renderNotes(this.currentFootnoteIds, this.footnoteMap, i),
          this.options.renderEndnotes &&
            r == l - 1 &&
            this.renderNotes(this.currentEndnoteIds, this.endnoteMap, i),
          this.options.renderFooters &&
            this.renderHeaderFooter(o.footerRefs, o, t.length, s != o, i),
          t.push(i),
          (s = o);
      }
      return t;
      ...
      for (let t of e) {
        if (t.type == C.Paragraph) {
          ...
          e?.paragraphProps?.pageBreakBefore &&
            ((r.sectProps = s),
            (r.pageBreak = !0),
            (r = { sectProps: null, elements: [], pageBreak: !1 }),
            a.push(r));
        }
    ...
    groupByPageBreaks(e) {
      ...
      for (let s of e)
        r.push(s),
          (this.options.ignoreLastRenderedPageBreak ||
            s.pageBreak ||
            this.isPageBreakSection(t, s.sectProps)) &&
            a.push((r = [])),
          (t = s.sectProps);
    ...
    renderCommentReference(e) {
      ...
      return (
        this.renderCommentContent(t, s),
        r.appendChild(
          this.htmlDocument.createComment(
            `comment #${t.id} by ${t.author} on ${t.date}`
          )
        ),
        r.appendChild(a),
        r.appendChild(s),
    ...
    renderCommentContent(e, t) {
      t.appendChild(
        _e("div", { className: `${this.className}-comment-author` }, [e.author])
      ),
        t.appendChild(
          _e("div", { className: `${this.className}-comment-date` }, [
    ...
    renderMmlRadical(e) {
      ...
      if (e.props?.hideDegree)
        return Ve(Oe, "msqrt", null, this.renderElements([t]));
    ...
    renderMmlDelimiter(e) {
      const t = [];
      return (
        t.push(Ve(Oe, "mo", null, [e.props.beginChar ?? "("])),
        t.push(...this.renderElements(e.children)),
        t.push(Ve(Oe, "mo", null, [e.props.endChar ?? ")"])),
        Ve(Oe, "mrow", null, t)
      );
    }
    renderMmlNary(e) {
      ...
      return (
        n || l
          ? t.push(Ve(Oe, "munderover", null, [o, l, n]))
          : n
          ? t.push(Ve(Oe, "mover", null, [o, n]))
          : l
          ? t.push(Ve(Oe, "munder", null, [o, l]))
          : t.push(o),
    ...
    renderMmlPreSubSuper(e) {
      const t = [],
        ...
        o = Ve(Oe, "mo", null);
      return (
        t.push(Ve(Oe, "msubsup", null, [o, l, n])),
        t.push(...this.renderElements(r[C.MmlBase].children)),
        Ve(Oe, "mrow", null, t)
      );
    }
    renderMmlGroupChar(e) {
      ...
      return (
        e.props.char && r.appendChild(Ve(Oe, "mo", null, [e.props.char])), r
      );
    }
    renderMmlBar(e) {
    ...
    renderMllList(e) {
      ...
      for (let r of this.renderChildren(e))
        t.appendChild(Ve(Oe, "mtr", null, [Ve(Oe, "mtd", null, [r])]));
      return t;
    }
      ...
      this.options.experimental &&
        ...
        (this.tabsTimeout = setTimeout(() => {
          ...
          for (let t of this.currentTabs)
            $e(t.span, t.stops, this.defaultTabSize, e);
        }, 500)));
    }
    later(e) {
